...
- Is there proper error tracking for monitoring and alerting?
...
Check for compliance with the project's error handling requirements as documented in AGENTS.md or equivalent project guidelines. Common expectations include:
- Never silently fail in production code
- Always log errors using appropriate logging functions
- Include relevant context in error messages
- Use proper error tracking for monitoring
