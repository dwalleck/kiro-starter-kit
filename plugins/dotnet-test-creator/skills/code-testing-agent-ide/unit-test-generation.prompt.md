...
- **Project reference validation**: Before writing test code, verify the test project references all source projects the tests will use. Read `.kiro/skills/code-testing-extensions/SKILL.md` and the language-specific extension file for guidance (e.g., `dotnet.md` for .NET)
